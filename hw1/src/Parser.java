...
class Parser {
    ...
    static class Tree {
        ...
        public String toString() {
            if (string == null) {
                string = new StringBuilder((left == null?0:left.toString().length()) + (right == null?0:right.toString().length()) + 5).append(left == null || right == null ? "" : "(")
                        .append(left == null ? "" : left.toString())
                        .append(sign)
                        .append(right == null ? "" : right.toString())
                        .append(left == null || right == null ? "" : ")").toString();
            }
            return string;
        }
