...
class Deduction {
    ...
    String makeFirstStr(String firstStr, boolean flage) {
    ...
    void solve(List<String> expressions, boolean flage) {

        result = new Vector<>();
        mpPrecalc = new HashMap<>();
        revForest = new HashMap<>();
        trees = new Vector<>();

        String firstStr = makeFirstStr(expressions.get(0), flage);
